 ...
 * Style Change for Bootstrap v3.0 by Orlando C. Rivera^2
...
!function( $ ) {
	...
	Datetimepicker.prototype = {
		...
		place: function(){
			...
			if(this.positioTop != undefined) {
				top = offset.top - this.picker.outerHeight() - this.positioTop;
			} else if (this.pickerPosition == 'top-left' || this.pickerPosition == 'top-right') {
